...
namespace Foundation.AspNetCore.Features.Blocks.BreadcrumbBlock
{
    public class BreadcrumbBlockController : BlockComponent<BreadcrumbBlock>
    {
        ...
        public override IViewComponentResult Invoke(BreadcrumbBlock currentBlock)
        {
            ...
            var view = View(model);
            view.ViewName = "~/Features/Blocks/BreadcrumbBlock/BreadcrumbBlock.cshtml";
            return view;
        }
    }
}
