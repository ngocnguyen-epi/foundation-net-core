...
using EPiServer.Web;
using Foundation.AspNetCore.Business.SelectionFactories;
using Foundation.AspNetCore.Features.CatalogContents.Shared.Models;
using Foundation.AspNetCore.Features.Shared;
using System.ComponentModel.DataAnnotations;

namespace Foundation.AspNetCore.Features.CatalogContents.Product.Models
{
    [CatalogContentType(
    ...
    public class GenericProduct : ProductContent, IProductRecommendations, IFoundationContent/*, IDashboardItem*/
    {
        ...
        [BackingType(typeof(PropertyString))]
        [Display(Name = "Manufacturer", GroupName = Global.TabNames.Manufacturer, Order = 5)]
        public virtual string Manufacturer { get; set; }

        [CultureSpecific]
        [Display(Name = "Manufacturer parts warranty description", GroupName = Global.TabNames.Manufacturer, Order = 10)]
        public virtual string ManufacturerPartsWarrantyDescription { get; set; }

        [BackingType(typeof(PropertyString))]
        [Display(Name = "Model", GroupName = Global.TabNames.Manufacturer, Order = 15)]
        public virtual string Model { get; set; }

        [Display(Name = "Model year", GroupName = Global.TabNames.Manufacturer, Order = 20)]
        [BackingType(typeof(PropertyString))]
        public virtual string ModelYear { get; set; }

        [BackingType(typeof(PropertyString))]
        [Display(Name = "Warranty", GroupName = Global.TabNames.Manufacturer, Order = 25)]
