...
namespace Foundation.AspNetCore.Features.CatalogContents.Shared.Controllers
{
    public class CatalogContentControllerBase<T> : ContentController<T> where T : CatalogContentBase
    {
        protected readonly bool _isInEditMode;
        ...
        public IActionResult AddAReview(ReviewSubmissionViewModel reviewForm)
        {
