...
using Foundation.AspNetCore.Features.CatalogContents.Shared.Services;
using Foundation.AspNetCore.Features.CatalogContents.Variation.Models;
using Foundation.AspNetCore.Features.CmsPages.Stores.Services;
using Foundation.AspNetCore.Features.CmsPages.Stores.ViewModels;
using Foundation.AspNetCore.Features.Media.Models;
using Foundation.AspNetCore.Features.MyOrganization.QuickOrderBlock;
    ...
    public class CatalogEntryViewModelFactory
    {
            ...
            where TViewModel : ProductViewModelBase<TProduct, TVariant>, new()
        {
            ...
            viewModel.Documents = currentContent.CommerceMediaCollection
                .Where(o => o.AssetType.Equals(/*typeof(PdfFile)*/typeof(MediaData).FullName.ToLowerInvariant()) || o.AssetType.Equals(typeof(StandardFile).FullName.ToLowerInvariant()))
