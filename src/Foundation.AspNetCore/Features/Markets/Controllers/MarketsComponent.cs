...
{
    public class MarketsViewComponent : FoundationViewComponent
    {
        ...
        private const string ViewName = "~/Features/Markets/Views/Markets.cshtml";
        ...
        public IViewComponentResult Invoke(ContentReference contentLink)
        {
            ...
            if (CacheManager.Get(Foundation.Commerce.Constant.CacheKeys.MarketViewModel + "-" + currentMarket.MarketId.Value) is MarketViewModel cache)
            {
