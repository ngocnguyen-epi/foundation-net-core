...
using Foundation.AspNetCore.Features.MyAccount.OrderDetails.Models;
using Foundation.AspNetCore.Features.MyAccount.OrderDetails.ViewModels;
...
namespace Foundation.AspNetCore.Features.MyAccount.OrderDetails.Controllers
{
    public class OrderDetailsController : PageController<OrderDetailsPage>
    {
        ...
        [HttpGet]
        public IActionResult Index(OrderDetailsPage currentPage, int orderGroupId = 0) => View(GetModel(orderGroupId, currentPage));

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ApproveOrder(int orderGroupId = 0)
        {
            if (orderGroupId == 0)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult CreateReturn(int orderGroupId, int shipmentId, int lineItemId, decimal returnQuantity, string reason)
        {
        ...
        [HttpPost]
        public IActionResult ChangePrice(int orderGroupId, int shipmentId, int lineItemId, decimal placedPrice, OrderDetailsPage currentPage)
        {
        ...
        [HttpPost]
        public IActionResult ChangeQuantity(int orderGroupId, int shipmentId, int lineItemId, decimal quantity, OrderDetailsPage currentPage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult AddNote(int orderGroupId, string note)
        {
