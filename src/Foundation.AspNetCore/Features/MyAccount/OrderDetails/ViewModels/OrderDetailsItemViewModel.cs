...
namespace Foundation.AspNetCore.Features.MyAccount.OrderDetails.ViewModels
{
    public class OrderDetailsItemViewModel
    {
        ...
        /// </summary>
        public IEnumerable<OrderForm> ReturnForms => PurchaseOrder
            .ReturnOrderForms
            .Where(x => x.Shipments.Any(y => y.ShipmentTrackingNumber.Equals(Shipment.ShipmentId.ToString()) && 
