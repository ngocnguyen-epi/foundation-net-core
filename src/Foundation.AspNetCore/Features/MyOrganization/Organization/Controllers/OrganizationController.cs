...
using Foundation.AspNetCore.Features.MyOrganization.Organization.ViewModels;
...
namespace Foundation.AspNetCore.Features.MyOrganization.Organization.Controllers
{
    [Authorize]
