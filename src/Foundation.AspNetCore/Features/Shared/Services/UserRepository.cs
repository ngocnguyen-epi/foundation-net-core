...
namespace Foundation.AspNetCore.Features.Shared.Services
{
    ...
    {
        private readonly ApplicationUserManager<ApplicationUser> _manager;

        public UserRepository(ApplicationUserManager<ApplicationUser> manager) => _manager = manager;
        ...
        {
            var userIdentity = _manager.FindByNameAsync(user.Identity.Name).Result;
