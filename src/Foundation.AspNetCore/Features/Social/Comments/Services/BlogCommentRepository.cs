using Foundation.AspNetCore.Features.Social.Comments.Interfaces;
using Foundation.AspNetCore.Features.Social.Services.Comments.Models;
using System.Collections.Generic;
using System.Linq;

namespace Foundation.AspNetCore.Features.Social.Comments.Services
{
    /// <summary>
    ...
    public class BlogCommentRepository : IBlogCommentRepository
    {
        ...
        private Comment AdaptBlogComment(BlogComment comment) => new Comment(Reference.Create(comment.Target), Reference.Create(comment.Name), comment.Body, true);
